  ...
  return (
    <footer className="relative bg-transparent text-gray-300 overflow-hidden border-t border-white/5">
      ...
      <div className="relative container mx-auto px-6 py-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Brand Section */}
        <div>
          <h2 className="text-2xl md:text-3xl font-extrabold mb-1 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent tracking-wide animate-gradient-x">
            MemoryLane
          </h2>
