...
const FeatureHighlights = ({ features = mockFeatures }) => {
  return (
    <section className="relative py-20 bg-gradient-to-b from-indigo-50 via-purple-50 to-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-16 text-gray-900">
          Why <span className="text-indigo-600">MemoryLane?</span>
        </h2>
